...
<div class="max-w-4xl mx-auto bg-white p-8 shadow rounded-lg">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Pengabdian</h1>

    <form action="{{ route('pengabdian.store') }}" method="POST" class="space-y-5">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="jenis_kegiatan" class="w-full border p-2 rounded" required>
        </div>
        ...
        <div>
            ...
            <textarea name="deskripsi" rows="4" class="w-full border p-2 rounded" placeholder="Tuliskan deskripsi kegiatan..."></textarea>
        </div>
